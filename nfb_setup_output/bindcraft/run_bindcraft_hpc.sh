...
PARAMS_FILE="params.bindcraft.json"
if [[ "bindcraft" == "rfd" ]]; then
...
nextflow \
  ...
  -resume \
  -with-report "results/logs/report_bindcraft_${DATESTAMP}.html" \
  -with-trace "results/logs/trace_bindcraft_${DATESTAMP}.txt"
