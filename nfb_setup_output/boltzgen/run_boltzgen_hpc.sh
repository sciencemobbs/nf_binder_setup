...
PARAMS_FILE="params.boltzgen.json"
if [[ "boltzgen" == "rfd" ]]; then
...
nextflow \
  ...
  -resume \
  -with-report "results/logs/report_boltzgen_${DATESTAMP}.html" \
  -with-trace "results/logs/trace_boltzgen_${DATESTAMP}.txt"
